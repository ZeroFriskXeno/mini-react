...
GENERIC_ERROR = STRING; // <= Error message for unexpected server errors
PORT = NUMBER;
FLAG_SHOW_GENERIC_DEV = true // <= Show generic error in development mode
```
